...
var index$4 = require('../../../hooks/use-form-item/index2.js');
var index$5 = require('../../../hooks/use-namespace/index2.js');
var core = require('@vueuse/core');
var types = require('../../../utils/types2.js');
var error = require('../../../utils/error2.js');
var index$6 = require('../../../hooks/use-common-props/index2.js');
...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { formItem } = index$4.useFormItem();
    const ns = index$5.useNamespace("input-number");
    ...
    const inputNumberSize = index$6.useSize();
    const inputNumberDisabled = index$6.useDisabled();
