...
var menuItem = require('./src/menu-item4.js');
var menuItemGroup = require('./src/menu-item-group3.js');
var subMenu = require('./src/sub-menu2.js');



exports.ElMenu = index.ElMenu;
exports.ElMenuItem = index.ElMenuItem;
exports.ElMenuItemGroup = index.ElMenuItemGroup;
exports.ElSubMenu = index.ElSubMenu;
exports["default"] = index.ElMenu;
