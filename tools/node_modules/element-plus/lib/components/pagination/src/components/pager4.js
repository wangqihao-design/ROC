    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("ul", {
        ...
        showPrevMore.value ? (vue.openBlock(), vue.createElementBlock("li", {
          ...
          quickPrevHover.value ? (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.DArrowLeft), { key: 0 })) : (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.MoreFilled), { key: 1 }))
        ...
        showNextMore.value ? (vue.openBlock(), vue.createElementBlock("li", {
          ...
          quickNextHover.value ? (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.DArrowRight), { key: 0 })) : (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.MoreFilled), { key: 1 }))
        ], 34)) : vue.createCommentVNode("v-if", true),
        _ctx.pageCount > 1 ? (vue.openBlock(), vue.createElementBlock("li", {
          ...
          tabindex: "0"
        }, vue.toDisplayString(_ctx.pageCount), 11, _hoisted_4)) : vue.createCommentVNode("v-if", true)
      ], 42, _hoisted_1);
    };
  }
});
